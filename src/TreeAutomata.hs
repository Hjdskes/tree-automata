...
widen' g1 g2 = do
  ...
  let correspondence = correspondenceSet g1' g2'
      ...
      arcs = arcReplacements wideClashes g1' g2'
  if trace ("Correspondence: " ++ show correspondence ++ "\nTC: " ++ show topoClashes ++ "\nWTC: " ++ show wideClashes ++ "\nArcs: " ++ show arcs) $ Set.null arcs
...
bestAncestor _ _ [] _ _ = Nothing
bestAncestor n n' ancs g1 g2 = let
  -- First find the ancestor closest to n'
  e = depth n' g2
